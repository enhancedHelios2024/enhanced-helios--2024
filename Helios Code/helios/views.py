...
def one_election_cast_confirm(request, election):
  ...
  if request.method == "GET":
    ...
    qr_code_string = "[secondCheck," + election.uuid + "," + election.name + "," + vote_fingerprint + "]"
    qr_code = generate_qr_code(qr_code_string)
...
def one_election_cast_done(request, election):
  ...
  print("logout: ", logout)
  qr_code_string = "[thirdCheck," + election.uuid + "," + election.name + "," + vote_hash + "]"
  qr_code = generate_qr_code(qr_code_string)
...
def voters_list_pretty(request, election):
  ...
  qr_code_string = "[BulletinBoard," + election.uuid + "," + election.name
  for vote_hash in castvote_list:
    print("Vote hash=============================-------", vote_hash)
    qr_code_string += "," + vote_hash
