...
MIDDLEWARE = [
    ...
    # 'helios_auth.middleware.SessionTimeoutMiddleware',
]
...
# EMAIL_PORT = 111  # Use the appropriate port
# EMAIL_USE_TLS = True  # Use TLS for secure connection
# EMAIL_HOST_USER = 'myemail'  # Your email address
# EMAIL_HOST_PASSWORD = 'password'  # Your email password or app-specific password
